...
public class ErrorMessages{
	...
	public ErrorMessages(){
		errorMessages.put(Integer.valueOf(-1), "Unknown Exception occured");
		...
		errorMessages.put(Integer.valueOf(30), "This API is unknown!");
		errorMessages.put(Integer.valueOf(31), "This API is not implemented yet!");
